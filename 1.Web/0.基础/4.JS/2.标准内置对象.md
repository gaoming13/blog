...
1. Object
  ...
  - Object构造函数的方法
    ...
    - 4. Object.defineProperties 给对象添加多个属性
      ...
      ```
    - 5. Object.entries 返回对象自身可枚举的 [key, value] 数组
    - 6. Object.freeze 冻结对象，其它代码不能删除或更改任何属性
    - 7. Object.getOwnPropertyDescriptor 返回对象指定的属性配置
    - 8. Object.getOwnPropertyNames 返回一个数组，包含所有可枚举或不可枚举的属性名字
    - 9. Object.getOwnPropertySymbols 返回一个数组，包含自身所有的Symbol属性
    ...
    - 15. Object.keys 返回一个数组，包含自身可枚举的属性名称(数组的key会变成字符串)
  ...
  - 如何遍历属性
    1. Object.keys (自身 && 仅可枚举)
    2. Objeect.getOwnPropertyNames (自身)
    3. for key in obj (自身+原型链 && 仅可枚举)
    ```js
    const arr = ['a', 'b'];
    arr.p1 = '123';
    Object.prototype.p2 = '456';
    // `Object.keys(obj)` (自身,仅可枚举的 !数组的key会变成字符串)
